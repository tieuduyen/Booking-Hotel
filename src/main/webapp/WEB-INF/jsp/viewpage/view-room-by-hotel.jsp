                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="offers_content">
                                                ...
                                                <div class="button book_button" style="background-color: #0069d9;"><a href="${pageContext.request.contextPath}/addToCart/${roomType.id}">Add to cart<span></span><span></span><span></span></a></div>y               
                                            </div>
                                        </div>
                                    </div>
                                </div>
